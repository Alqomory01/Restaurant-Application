...
| `store_keeper` | Store Keeper | The Store module only (suppliers, item master, purchase orders, receiving) — can create POs and receive goods, but can't approve a PO. No Kitchen module. |
